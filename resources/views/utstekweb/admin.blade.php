...
<head>
  ...
  <link rel="stylesheet" href="admin/template/vendors/simple-line-icons/css/simple-line-icons.css">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top"> 
        <ul class="navbar-nav d-flex">
          <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
            <h1 class="welcome-text">Good Morning, <span class="text-black fw-bold">Fieter</span></h1>
          </li>
