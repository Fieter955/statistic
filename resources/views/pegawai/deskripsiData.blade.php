        ...
        <div class="flex-1 p-8">
            <div class="max-w-xl mx-auto bg-white p-8 rounded shadow-lg">
                ...
                <table class="w-full mb-6">
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border-b">Nilai Minimum</th>
                            <th class="py-2 px-4 border-b">Nilai Maksimum</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="py-2 px-4 border-b text-center">{{ $minScore }}</td>
                            <td class="py-2 px-4 border-b text-center">{{ $maxScore}}</td>
                            <td class="py-2 px-4 border-b text-center">{{ $mean}}</td>
                        </tr>
